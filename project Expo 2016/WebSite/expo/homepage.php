...
<html lang="th">
	<head>
		<title>SAU EXPO</title>
		<meta charset="UTF-8"/>
	</head>


	<!-- <meta http-equiv='refresh' content ='10;Url=test2.php'> -->
<link href="images/lucky.png" rel="shortcut icon" type="image/x-icon" />
		      ...
		      <!-- .navbar-header -->
			    <div class="collapse navbar-collapse" id="navbar-collapse-main">
			        <ul class="nav navbar-nav navbar-right">
				        ...
				        <li><a class="page-scroll" href="#luckyDown">Lucky Draw</a></li>
			        </ul>
			    </div>
	...
	<div id="luckyDown" class="pad-section section no-padding">
		<div class="container-fluid text-center" >
		      	<div class="row sectionTitle" >
			   		<h1 class="text-default" style="font-size: 38px;"><strong>LUCKY DRAW !!</strong></h1>
			   		<p >
		...
		<div class="container-fluid">
			...
			<div class="row" style="padding:30px 0 30px 0; background-color: #333">
				<div class="copyright text-center">
					Copyright &copy; 2016, The project by <span style="color: #fff;">Manit Cholpinyo ,Pongsakorn Srisintorn</span> @ SAU EXPO
				</div>
