                                        ...
                                        while ($row = mysql_fetch_array($res))
                                        {
                                            ...
                                            <form action="?Act=UpdataUser&login_id=<?=$id;?>" method="post" role="form" enctype="multipart/form-data">
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="two" name="login_username" value="<?php echo $login_username; ?>"></td>
                                                    <td><input type="text" class="two" name="login_password" value="<?php echo $login_password; ?>"></td>
