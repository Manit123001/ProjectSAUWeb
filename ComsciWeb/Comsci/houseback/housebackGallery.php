...
<body>
    ...
    switch($Act){
        case 'AddGallery' :
                    ...
                    $res = Select("tbgallery", "order by id desc limit 1" );
                    while ($row = mysql_fetch_array($res))
                    {
                        $idx = $row['id'];
                        $nameGroup = ($name*$Num_Rows)+$idx;
                ...
                <div class="panel-body">
                        ...
                        while ($row = mysql_fetch_array($res))
                        {
                          ...
                          <div class="col-md-6">
                              ...
                              <form action="?Act=AddGallery&id=<?=$id;?>" method ="post" class="form-horizontal" role="form" enctype="multipart/form-data">
