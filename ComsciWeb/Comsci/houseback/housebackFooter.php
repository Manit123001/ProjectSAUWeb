    ...
    switch($Act){
        case 'UpdateSectionBox':
                    ...
                    $Update = Update("tbsection_box", "
                        ...
                        section_link='".$section_link."' WHERE id = '".$id."'");
                        ...
                        <form action="?Act=UpdateSectionBox&id=<?=$id;?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                            <div class="col-md-11">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text"  name="section_title" id="section_title" value="<?php echo $section_title; ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">ลิงค์สมัคร</label>

                                    <div class="col-md-10">
                                      <input type="text"  name="section_link" id="section_link" value="<?php echo $section_link; ?>">
                                    </div>
